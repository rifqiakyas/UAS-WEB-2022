        ...
        <div class="col-lg-3 col-md-6 col-sm-12 pb-1">
            <div class="card product-item border-0 mb-4">
                <div class="card-header product-img position-relative overflow-hidden bg-transparent border p-0">
                    <img class="img-fluid w-100" src="assets/img/<?=$row['gambar'];?>" alt="">
                </div>
                <div class="card-body border-left border-right text-center p-0 pt-4 pb-3">
                    <h6 class="text-truncate mb-3"><?=$row['namabarang'];?></h6>
                    <div class="d-flex justify-content-center">
                    <div class="space"><h6>stok: <?=$row['stok'];?></h6>
...
<div class="container-fluid pt-5">
    ...
    <?php foreach ($models as $row) : ?>
        ...
        <!-- /*<div class="col-lg-3 col-md-6 col-sm-12 pb-1">
            <div class="card product-item border-0 mb-4">
                <div class="card-header product-img position-fixed overflow-hidden bg-transparent border p-0">
